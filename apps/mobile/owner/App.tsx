...
// SCAFFOLD — apps/mobile/owner (Owner App)
// KPI dashboard, AI Copilot, Digital Twin, multi-store oversight, push alerts.
...
export default function App() {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.body}>KPI dashboard, AI Copilot, Digital Twin, multi-store oversight, push alerts.</Text>
