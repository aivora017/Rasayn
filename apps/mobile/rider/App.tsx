...
// SCAFFOLD — apps/mobile/rider (Rider App)
// Last-mile delivery — pickup, route, signature, COD reconcile via Shiprocket+Dunzo.
...
export default function App() {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.body}>Last-mile delivery — pickup, route, signature, COD reconcile via Shiprocket+Dunzo.</Text>
