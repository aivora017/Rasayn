...
Generated 2026-04-27T13:11:28.599Z.
...
|---|---|---|---:|---:|---:|---|
| a10 | 0015 | 100-bill GSTR-1 generate p95 <2000ms | 0.63 | 1.96 | 2000 | OK |
...
| a6 | 0010 | A6 — 10-line bill save, p95 < 400ms (ADR 0004 row A6) | 2.11 | 3.49 | 400 | OK |
| a8 | 0021 | 5-line partial refund: compute + save p95 <300ms | 0.01 | 0.03 | 300 | OK |
| a9 | 0014 | Invoice/credit-note HTML render p95 <50ms | 0.06 | 0.19 | 200 | OK |

## Runner

- node v24.14.1 on win32/x64
